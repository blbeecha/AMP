...
//The following namespaces are included in the standard .NET Framework Class Library
using System;
...
class Program
    {
        static string [] initializeAccounts() 
        {
        ...
        static string [] initializeOrganizations()
        {
        ...
        static string [] initializeBalances()
        {
            //open file, it will be created in initializeAccounts if it doesn't exist
            var fileName = "savedData.xml";
            var currentDirectory = Directory.GetCurrentDirectory();
